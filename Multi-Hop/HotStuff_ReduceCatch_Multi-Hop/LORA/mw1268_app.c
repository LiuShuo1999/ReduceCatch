...
///////////////////////////////////////////////////////////////////////////////////////////////////
			if(LoRa_CFG.tmode == LORA_TMODE_PT){
				...
				if(!start_flag && uart3RxBuffer[0]==0xff && uart3RxBuffer[1]==0xff && uart3RxBuffer[2]==0xff){
					...
					NTX_proposal = uart3RxBuffer[6];
					Global_NTX_proposal = uart3RxBuffer[7];
					Extera_slot = uart3RxBuffer[8];
				}
				...
				// 处理数据
				if(verify_flag && !verify_flag2 && uart3RxBuffer[1]==CATCHING && uart3RxBuffer[3]==PREPREPARE){
					Need_proposal = 1;
				}
...
//					}
//				}
				else if(verify_flag && !verify_flag2 && uart3RxBuffer[1]==GLOBAL_CATCHING && uart3RxBuffer[3]==GLOBAL_PREPREPARE){
					Need_proposal_2 = 1;
				}
...
//						if(verify_sig) Rece_decide = 1;
				...
				else if(verify_flag2 && verify_flag && (temp_type == GLOBAL_CATCHING)){
					if(id==Global_Consensus_Leader && temp_id != Global_Consensus_Leader){
						u8 catching_type = uart3RxBuffer[3];
