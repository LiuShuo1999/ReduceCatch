...
///////////////////////////////////////////////////////////////////////////////////////////////////
			if(LoRa_CFG.tmode == LORA_TMODE_PT){
				...
				else if(uart3RxBuffer[1]==NACK && uart3RxBuffer[3]==PROPOSAL){
					verify_flag2 = 0;
				...
				else if(uart3RxBuffer[1]==GLOBAL_NACK && uart3RxBuffer[3]==GLOBAL_PROPOSAL_2){
					verify_flag2 = 0;
					temp_datasize = uart3RxBuffer[2];
					prefix_proposal = 3;
				}
...
//						}
				...
				else if(verify_flag && (temp_type == NACK)){
...
//					}
//				}
				else if(verify_flag && !verify_flag2 && uart3RxBuffer[1]==GLOBAL_NACK && uart3RxBuffer[3]==GLOBAL_PROPOSAL_2 && id == Global_Consensus_Leader){
