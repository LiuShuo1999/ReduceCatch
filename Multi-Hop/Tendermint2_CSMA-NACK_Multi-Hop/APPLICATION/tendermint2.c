...
/*****************************Local_Consensus**************************************************************************************************************************************************************************/
	...
	if(id==Group_Leader_ID)Propose(0);
...
/*****************************Global_Consensus**************************************************************************************************************************************************************************/
	...
	if(id==Global_Consensus_Leader)Global_Propose();
...
void NACK_phase(){
	if(id==Group_Leader_ID){
		...
		if(Prepare_Number < (2*f+1)){
			...
			Leader_NACK(PREVOTE,Rece_Prepare);
...
//		}
		...
		if(Global_Prepare_Number < (2*Global_f+1)){
			...
			Global_Leader_NACK(GLOBAL_PREVOTE,Global_Rece_Prepare);
