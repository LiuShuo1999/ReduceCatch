...
///////////////////////////////////////////////////////////////////////////////////////////////////
			if(LoRa_CFG.tmode == LORA_TMODE_PT){
				...
				if(verify_flag && !verify_flag2 && uart3RxBuffer[1]==CATCHING && uart3RxBuffer[3]==PROPOSAL){
					...
					if(Commit[temp_id] == 0xFF){
						Commit[temp_id] = temp_commit;
						if(temp_commit)
...
//							hash[3] = 1;
					...
					u8 temp_value = uart3RxBuffer[3];
					if((id == 1) && (Viewchange_Number <= Need_to_Wait) && (Rece_Viewchange[temp_id]==0xFF) && (temp_value==1)){
